...
export default async function DashboardPage() {
  ...
  // Calculate total potential monthly revenue (sum of all rent prices)
    ...
    <div className="max-w-6xl mx-auto p-4 sm:p-6 lg:p-8 mt-4">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
        ...
        <div className="flex items-center gap-3">
          {/* NEW: Button to take landlord to their Tours Page */}
          <Link
            href="/mgmt/tours"
            ...
            {myProperties.map((property) => (
              <div key={property.id} className="p-6 flex flex-col md:flex-row md:items-center justify-between gap-4 hover:bg-slate-50 transition-colors">
                ...
                <div className="flex-grow flex items-center gap-4">
                  ...
                  <div>
                    <div className="flex items-center gap-3 mb-1">
                      ...
                      <span className={`text-xs font-bold px-2.5 py-1 rounded-full ${property.isAvailable ? 'bg-emerald-100 text-emerald-700' : 'bg-amber-100 text-amber-700'}`}>
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6 md:gap-8">
                  ...
                  {/* The interactive island component for Edit/Delete */}
